 ...
 */
  ...
  const _getTokensAfterRemove = async (_removeLPTokens) => {
    try {
      ...
      const cryptoBoiiiTokenReserve = await getReserveOfCDTokens(provider);
      // call the getTokensAfterRemove from the utils folder
      const { _removeEther, _removeCD } = await getTokensAfterRemove(
        provider,
        removeLPTokenWei,
        _ethBalance,
        cryptoBoiiiTokenReserve
      );
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Crypto Boiii Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} Crypto Boiii LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of CryptoBoiii tokens"
                  onChange={(e) =>
                    setAddCDTokens(
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`You will need ${utils.formatEther(addCDTokens)} Crypto Boiii
                  Tokens`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  Add
            ...
            <div>
              ...
              Boiii Tokens and ${utils.formatEther(removeEther)} Eth`}
              </div>
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoBoiiiToken">Crypto Boiii Token</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      <Head>
        <title>Crypto Boiiis DeFi</title>
        <meta name="description" content="Exchange dApp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Crypto Boiiis Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Crypto Boiii Tokens
          </div>
          <div>
            <button
